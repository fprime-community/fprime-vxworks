...
#define VxWorksUartDriver_HPP

#include <VxWorks/Drv/VxWorksUartDriver/VxWorksUartDriverComponentAc.hpp>
...
class VxWorksUartDriver final : public VxWorksUartDriverComponentBase {
  public:
    ...
    //! Construct object VxWorksUartDriver
    //!
    VxWorksUartDriver(const char* const compName /*!< The component name*/
    );
    ...
    //! Destroy object VxWorksUartDriver
    //!
    ~VxWorksUartDriver();
