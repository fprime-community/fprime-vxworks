/**
 * \brief PlatformTypes.hpp for VxWorks systems
 *
 ...
 * types header is designed to support standard VxWorks distributions
 * using compilers used with your VxWorks build.
 *
